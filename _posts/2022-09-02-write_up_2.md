...
<div style="margin-left:5%;margin-right:5%;">
<h5> 어색함을 찾지 못했다... 혹시몰라 이미지파일의 경로를 하나하나 다 용청해봤지만 404..그렇게 소스코드와 burp suite을 보며 고민하다 갑자기 떠오른 문제의 제목 'Future <b>Browser</b>'! 그리고 /secret 페이지에선 '보안상 hackingcamp <b>브라우저</b>를 통해서만 접근하실 수 있습니다' 라고 했다!😏
</h5></div>
